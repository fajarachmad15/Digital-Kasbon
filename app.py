...
# --- BAGIAN BARU: LOGIKA LOGIN GOOGLE ---
...
# Simpan email google ke variabel pic_email
...
# --- 5. TAMPILAN INPUT USER ---
    ...
    if st.session_state.submitted:
        ...
        # Tambahan Tombol Logout agar User bisa ganti akun
        c1, c2 = st.columns(2)
        ...
        if kode_store != "":
            ...
            # --- PERUBAHAN: EMAIL DIAMBIL DARI LOGIN GOOGLE ---
